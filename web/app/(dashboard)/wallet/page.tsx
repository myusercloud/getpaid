        ...
        <>
          {!membership?.isActive && (
            <Card>
              ...
              <p className="text-sm text-gray-500 mb-4">Costs KES {MEMBERSHIP_COST}. You&apos;ll receive a KES 20 bonus upon activation.</p>
  ...
  if (submitted) {
    return (
      <Card className="text-center py-10">
        ...
        <p className="text-sm text-gray-500 mt-1">We&apos;ll process your withdrawal to <strong>{phone}</strong> shortly.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-sm text-gray-500 font-medium">+254</span>
            <input
              type="tel"
              value={phone}
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            max={balance}
            required
            className="block w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 overflow-hidden">
        ...
        {step === "confirm" && (
          <div className="p-6">
            ...
            <h2 className="text-lg font-bold text-gray-900 text-center mb-6">Confirm Payment</h2>
        ...
        {step === "processing" && (
          <div className="p-8 flex flex-col items-center">
            ...
            <div className="w-full space-y-3">
              ...
              <ProcessingStep label="Verifying funds" done={dots.length >= 2} />
