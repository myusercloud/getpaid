      ...
      <Card>
        ...
        <form onSubmit={saveName} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5">{u?.email}</p>
      ...
      <Card>
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex items-center justify-between py-2 border-b border-slate-100">
            ...
            <span className="font-mono text-slate-800 text-xs bg-slate-100 px-2 py-1 rounded-lg">{u?.referralCode}</span>
          </div>
